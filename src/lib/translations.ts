...
export const translations = {
  ja: {
    ...
    atelier: {
      ...
      writePill: "書いた言葉を入力",
      reading: "読んでいます…",
      guessTitle: "こう読めました。どれですか？",
      guessType: "入力する",
      correct: "直す",
      correctRead: "「{word}」と読みました。直す",
      noteRecognized: "手書きを読み取りました。違っていれば直してください。",
      noteNoRecognition: "読み取れませんでした。言葉を入力してください。",
      ...
      indexIntro: "描かずに開く入口。",
      helpSteps: [
        "知りたいことを、紙に書く（実績・私について・コンタクト など）。",
        "書いた字がそのまま読み取られて、ボタンになる。",
        "押すと、そこから情報がひらく。読み違えたら「直す」で直せる。",
      ],
      helpBox: "四角や丸を描いて、その中に文字を入力することもできます。",
      helpMore: "2つの言葉を線でつなぐと、その関係が出ます。",
      helpPrivacy: "手書きを読むために、書いた線の座標を Google の手書き入力に送っています。入力した文字は送っていません。",
      ...
      a11y: {
        ...
        read: "「{label}」と読み取って、{topic}をひらきました。",
        guessing: "「{word}」と読めましたが、対応する項目がありません。候補から選べます。",
        notRead: "読み取れませんでした。言葉を入力してください。",
  ...
  en: {
    ...
    atelier: {
      ...
      reading: "Reading…",
      guessTitle: "Is it one of these?",
      guessType: "Type it instead",
      correct: "Fix",
      correctRead: "Read as “{word}”. Fix it",
      noteRecognized: "Read from your handwriting — fix it if it's wrong.",
      noteNoRecognition: "That couldn't be read. Please type the word.",
      ...
      helpSteps: [
        "Write what you want to know, anywhere on the paper (Work, About, Contact…).",
        "Your handwriting is read, and the strokes become the button.",
        "Press it and the page opens from there. If it misreads, use “Fix”.",
      ],
      helpBox: "You can also draw a box or a circle and type inside it.",
      helpMore: "Draw a line between two words to see how they relate.",
      helpPrivacy: "To read handwriting, the coordinates of your strokes are sent to Google's handwriting input. Anything you type is not sent.",
      ...
      a11y: {
        ...
        read: "Read “{label}” and opened {topic}.",
        guessing: "Read “{word}”, which doesn't match a section. Pick from the candidates.",
        notRead: "That couldn't be read. Please type the word.",
        opened: "Opened {topic}.",
        closed: "Closed {topic}.",
